...
//
#ifndef RTW_HEADER_SMC_types_h_
#define RTW_HEADER_SMC_types_h_
#include "rtwtypes.h"
...
typedef struct P_SMC_T_ P_SMC_T;

// Forward declaration for rtModel
typedef struct tag_RTM_SMC_T RT_MODEL_SMC_T;

#endif                                 // RTW_HEADER_SMC_types_h_
