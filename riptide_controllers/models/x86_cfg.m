function cs = x86_cfg()
% MATLAB function for configuration set generated on 14-Jan-2024 13:36:21
...
cs.set_param('Name', 'x86_cfg'); % Name
...
cs.set_param('CustomSource', sprintf('%s','thruster_solver/send_thruster_cmd_canbus.c',''));   % Source files
