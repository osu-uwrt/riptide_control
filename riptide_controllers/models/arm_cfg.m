function cs = arm_cfg()
% MATLAB function for configuration set generated on 14-Jan-2024 13:33:13
...
cs.set_param('ProdHWDeviceType', 'ARM Compatible->ARM 64-bit (LP64)');   % Production device vendor and type
...
cs.set_param('IncludeModelTypesInModelClass', 'off');   % Include model types in model class
