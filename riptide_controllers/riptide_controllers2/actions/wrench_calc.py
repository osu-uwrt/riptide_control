...
#given magnitudes of hexapod forces and experimental wrench, calculate the wrench generated by the bot

def solve_bot_wrench_1(hex_mags : np.ndarray, exp_wrench : np.ndarray) -> np.ndarray:
    return solve_bot_wrench_2(calc_wrench_1(hex_mags), exp_wrench)
    end


#given hexapod applied wrench and experimental wrench, calculate the wrench generated by the bot

def solve_bot_wrench_2(hex_wrench : np.ndarray, exp_wrench : np.ndarray) -> np.ndarray:
    return exp_wrench - hex_wrench
    end
